      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-background">
          ...
          <p className="mt-4 text-lg opacity-0 animate-fade-in-up animation-delay-400">
            Design spaces that inspire generations.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-10 opacity-0 animate-fade-in-up animation-delay-200">
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              <Link href="/signup" className="text-foreground underline underline-offset-4 transition-colors hover:text-muted-foreground">
                Sign up
              </Link>
            </p>
          </div>
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="space-y-6 opacity-0 animate-fade-in-up animation-delay-400">
            <div>
